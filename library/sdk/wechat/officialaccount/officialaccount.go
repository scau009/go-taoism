...
import (
	...
	"dev.taoism.gz.cn/go-taoism/library/sdk/wechat/officialaccount/draft"
	"dev.taoism.gz.cn/go-taoism/library/sdk/wechat/officialaccount/freepublish"
	"dev.taoism.gz.cn/go-taoism/library/sdk/wechat/officialaccount/ocr"

	"dev.taoism.gz.cn/go-taoism/library/sdk/wechat/officialaccount/datacube"

	"dev.taoism.gz.cn/go-taoism/library/sdk/wechat/credential"
	"dev.taoism.gz.cn/go-taoism/library/sdk/wechat/officialaccount/basic"
	"dev.taoism.gz.cn/go-taoism/library/sdk/wechat/officialaccount/broadcast"
	"dev.taoism.gz.cn/go-taoism/library/sdk/wechat/officialaccount/config"
	"dev.taoism.gz.cn/go-taoism/library/sdk/wechat/officialaccount/context"
	"dev.taoism.gz.cn/go-taoism/library/sdk/wechat/officialaccount/device"
	"dev.taoism.gz.cn/go-taoism/library/sdk/wechat/officialaccount/js"
	"dev.taoism.gz.cn/go-taoism/library/sdk/wechat/officialaccount/material"
	"dev.taoism.gz.cn/go-taoism/library/sdk/wechat/officialaccount/menu"
	"dev.taoism.gz.cn/go-taoism/library/sdk/wechat/officialaccount/message"
	"dev.taoism.gz.cn/go-taoism/library/sdk/wechat/officialaccount/oauth"
	"dev.taoism.gz.cn/go-taoism/library/sdk/wechat/officialaccount/server"
	"dev.taoism.gz.cn/go-taoism/library/sdk/wechat/officialaccount/user"
)
